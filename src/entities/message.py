...
class Message:
    ...
    def __init__(
        self, to: str, body: str = "", media_url: str = None, media_type: str = None
    ):
        self.to = to
        self.body = body
        self.media_url = (
            media_url  # URL del archivo multimedia (imagen, audio, documento, etc.)
        )
        self.media_type = (
            media_type  # Tipo MIME del archivo (image/jpeg, audio/mpeg, etc.)
        )
